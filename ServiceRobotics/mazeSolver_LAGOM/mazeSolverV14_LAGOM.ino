...
int error = 0;
float pidTerm = 0;
float Kp = 0.017; //0.017//0.013;
float Kd = 0.0;
float err_sum = 0;
float err_dif = 0;
float RWBaseSpeed = 17; // 14//+ 90 to get actual speed, 0 -> 180
float LWBaseSpeed = -17; //-14
float RWSpeed;
float LWSpeed;
int e2 = 0;
int e3 = 0;
...
void initSetup(){
    ...
    delay(100);
    if(!autoCal){ //Set the cal. values of the sensor from the manual calibration numbers
      for(int i = 0; i< NUM_SENSORS; i++){
